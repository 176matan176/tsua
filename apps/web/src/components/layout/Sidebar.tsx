...
const NAV_ITEMS = [
  ...
  { key: 'sectors',     icon: Squares2X2Icon,   iconActive: Squares2X2IconSolid,   href: '/sectors',     label: 'מגזרים' },
  { key: 'crypto',      icon: CurrencyDollarIcon, iconActive: CurrencyDollarIconSolid, href: '/crypto',   label: '₿ קריפטו' },
  { key: 'compare',     icon: ScaleIcon,        iconActive: ScaleIconSolid,        href: '/compare',     label: 'השוואה' },
